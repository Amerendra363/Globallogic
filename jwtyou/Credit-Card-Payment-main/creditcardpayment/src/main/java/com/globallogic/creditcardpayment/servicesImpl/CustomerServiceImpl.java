...
public class CustomerServiceImpl implements CustomerService {
	...
	public String deleteCustomer(long id) {
		...
		System.out.println("user deleted successfully "+userRepo.findById(customer.getUser().getUserName()).get());
		userRepo.deleteById(customer.getUser().getUserName());
		System.out.println();
	...
	public List<Customer> addCustomer2(Customer customer) {
		...
		User user = userRepo.findById(customer.getUser().getUserName()).get();
